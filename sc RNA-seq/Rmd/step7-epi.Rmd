...
#应用infercnv的结果
load('infercnv.Rdata')
infer_CNV_obj<-readRDS('CNV/infercnv_output/run.final.infercnv_obj')
...
### 7. 经过marker基因查看和CNV分析后，人工注释细胞亚群
